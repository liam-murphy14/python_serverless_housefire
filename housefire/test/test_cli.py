...
class TestCli(unittest.TestCase):
    ...
    def test_transform_command(
        ...
        mock_hf_config.return_value = mock_config
        # mock_factory = MagicMock(spec=HousefireLoggerFactory)
        mock_logger_factory.get_logger.return_value = MagicMock(spec=logging.Logger)
        # mock_logger_factory.return_value = mock_factory
