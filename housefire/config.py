...
class HousefireConfig:
    ...
    def is_initialized(self, config_object: configparser.ConfigParser):
        return "HOUSEFIRE" in config_object and "TEMP_DIR_PATH" in config_object["HOUSEFIRE"] and "HOUSEFIRE_API_KEY" in config_object["HOUSEFIRE"] and "GOOGLE_MAPS_API_KEY" in config_object["HOUSEFIRE"] and "HOUSEFIRE_BASE_URL" in config_object["HOUSEFIRE"]
